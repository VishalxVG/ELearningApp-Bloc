        ...
        data: json["data"] == null
            ...
            : List<CourseItem>.from(
                json["data"].map(
                  ...
                  // {...} , {...}
                  // ]
                  // X defines this each {} , which then stores in CourseItem class
                  // which has all the specific items referencing to the specific data values
...
class CourseItem {
  ...
  factory CourseItem.fromJson(Map<String, dynamic> json) => CourseItem(
        ...
        video: json["video"],
        //! In backend the price is stored as decimal , but here it is stored as string
        //! so we need to convert the decimal into string
